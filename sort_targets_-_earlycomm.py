...
02-19-2016 -- this version ("-_earlycomm.py") has hard-coded parameters for
EARLY COMMISSIONING / INITIAL IMAGE MOSAIC
python2 sort_targets_-_earlycomm.py ../target_lists/initial_image_mosaic_R90 ../initial_image_mosaic_R90_avail.npy
